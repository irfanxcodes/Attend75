...
def login_user(roll_number: str, password: str, user_agent: str | None = None) -> dict:
    ...
    try:
        ...
        register_student_login(roll_number.strip().upper(), "guest", display_name=resolved_user_name, attendance_percent=overall_percent, user_agent=user_agent, program=data.get("program_full"), current_semester=_resolve_semester_label(data))
