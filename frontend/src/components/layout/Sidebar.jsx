      ...
      >
        ...
        <div className="border-t border-white/10 px-4 py-3">
          <div className="flex items-center gap-2">
            ...
            <a href="https://www.instagram.com/irfan0_7_?igsh=eTNvMjNuNmozMHVt" target="_blank" rel="noopener noreferrer" className="flex h-7 w-7 items-center justify-center rounded-lg bg-[#3D3660] border border-white/10 text-[#D8D4E7] transition hover:border-[#E1306C]/40 hover:text-[#E1306C]">
            ...
            <a href="https://www.linkedin.com/in/irfan-ansari-13b77425b" target="_blank" rel="noopener noreferrer" className="flex h-7 w-7 items-center justify-center rounded-lg bg-[#3D3660] border border-white/10 text-[#D8D4E7] transition hover:border-[#0A66C2]/40 hover:text-[#0A66C2]">
