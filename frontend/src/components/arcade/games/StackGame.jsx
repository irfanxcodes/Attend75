...
// === REACT COMPONENT ===
function StackGame({ onGameEnd, onScoreUpdate, isActive }) {
  ...
  useEffect(() => { if (isActive && !pRef.current) { start(); onScoreUpdate(0) }; pRef.current = isActive }, [isActive, start, onScoreUpdate])
