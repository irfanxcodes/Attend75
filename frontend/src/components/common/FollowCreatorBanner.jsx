...
const INSTAGRAM_URL = 'https://www.instagram.com/irfan0_7_?igsh=eTNvMjNuNmozMHVt'
const LINKEDIN_URL = 'https://www.linkedin.com/in/irfan-ansari-13b77425b'
  ...
  return (
    <div className={`flex items-center gap-3 ${className}`}>
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="flex h-8 w-8 items-center justify-center rounded-lg bg-[#3D3660] border border-white/10 text-[#D8D4E7] transition hover:border-[#0A66C2]/40 hover:text-[#0A66C2]"
        aria-label="LinkedIn"
      >
